...
from app.modules.compare.compare_text import (OcrUnavailable, TextResult, Word, _missing_diff, compare_words, order_words, word_key)
...
def is_tilde_missing(d) -> bool:
    ...
    if not d.expected or not d.found or d.expected == d.found:
        return False
    from app.modules.compare.compare_text import strip_accents
