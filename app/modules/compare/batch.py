...
from app.loaders import load_as_image, page_count
from app.modules.compare.pipeline import run_comparison
from app.modules.compare.scoring import status_for
...
def merge_reports(batch_id: str, out_path: Path) -> Path:
    ...
    from app.modules.compare.report import build_report, STATUS
