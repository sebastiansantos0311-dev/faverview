...
from app.modules.compare import ignore_zones
from app.modules.compare.align import align_images
from app.modules.compare.compare_color import grid_color_diffs, text_color_diffs
from app.modules.compare.compare_text import (OcrUnavailable, Word, _missing_diff, compare_words, layout_words, ocr_words)
from app.modules.compare.compare_visual import compare_visual, make_outputs, save_jpg
from app.config import CFG, RESULTS_DIR, load_config
from app.modules.compare.fonts import compare_fonts, fonts_in_design
from app.learning import confusions, store as learning_store, tuning, vocab
from app.learning.imagetype import classify as classify_image
from app.modules.compare.photometry import normalize_illumination
from app.modules.compare.ocr_guided import compare_guided, ocr_page_adaptive, read_region
from app.loaders import color_space, extract_pdf_layout, load_as_image, page_count, validate_file
from app.modules.compare.models import Difference, Result
from app.modules.compare.scoring import compute_scores
from app.modules.compare.spelling import check_spelling
...
def run_comparison(job_id: str, client_path, design_path, params: dict | None = None,
    ...
    from app.modules.compare.ocr_guided import is_tilde_missing
