...
from app.modules.compare.align import _resize_to
from app.modules.compare.compare_color import delta_e_hex, grid_color_diffs
from app.modules.compare.compare_text import Word, compare_words, layout_words
...
from app.modules.compare.fonts import fonts_in_design
from app.loaders import extract_pdf_layout, load_as_image, page_count, validate_file
from app.modules.compare.models import Difference, Result
from app.modules.compare.pipeline import STAGES, _dedupe, _intersects
